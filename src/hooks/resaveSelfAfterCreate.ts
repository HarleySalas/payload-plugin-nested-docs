 ...
 * so that we can build it's breadcrumbs with the newly created document's ID
 */

export const resaveSelfAfterCreate = (pluginConfig: PluginConfig, collection: CollectionConfig): CollectionAfterChangeHook =>
